...
class DebtReportWizard(models.TransientModel):
    ...
    def action_print_summary(self):
        ...
        return self.env.ref('qlv.action_report_debt_summary').report_action(self, data=data)
    ...
    def action_print_detail(self):
        ...
        return self.env.ref('qlv.action_report_debt_detail').report_action(self, data=data)
