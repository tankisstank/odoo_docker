...
class StockMove(models.Model):
    ...
    gold_purity = fields.Float('Tuổi vàng (Hệ số)', digits=(16, 4), help="Hệ số tuổi vàng thực tế tại thời điểm nhập kho.")
    price_compensation = fields.Monetary('Tiền bù giá', currency_field='currency_id', help="Số tiền khách bù thêm để điều chỉnh giá trị.")
    price_unit_base = fields.Float('Đơn giá gốc', related='sale_line_id.price_unit_base', readonly=True, store=False)
